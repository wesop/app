<template>
<div class="policy-contents-wrap">
개인정보취급방침
...
제 3 조 (개인정보 수집항목)
사이트에서는 별도의 회원가입 절차 없이 특정 유료 서비스를 제외한 대부분의 컨텐츠에 자유롭게 접근할 수 있으며, 회원제 서비스를 이용하시려면 필수항목을 입력하여야 하며 선택항목을 입력하지 않더라도 서비스 이용에 제한을 두지 않습니다.
가. 수집하는 개인정보의 항목
1. 회원가입 시 수집하는 항목
1) 개인회원
...
[위솝 고객센터]
 ...
 - 전화번호 : 070-8633-1157
 - 주 소 : 서울특별시 강남구 논현로98길 28 (역삼동, 시티빌딩)
